...
Python module for sending and receiving 433/315MHz LPD/SRD signals with generic low-cost GPIO RF modules on a NodeMCU with uPython
Base Intelligence forked from rpi-rf project for Raspberrypi and modified to working on Micro Python
...
Most generic 433/315MHz capable modules (cost: ~2€) connected via GPIO to a ESP8266/ESP32.
